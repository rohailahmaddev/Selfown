    ...
    <div className=" bg-indigo-100 flex justify-between w-full">
      ...
      <ul className="w-[70%] flex flex-col">
        {array.map((ele, index) => {
          return (
            <li key={index}>
              <div className="flex items-center justify-between p-5 bg-white w-full border-b border-dashed border-blue-300">
                {openIndex === index ? (
                  <GrFormSubtract
                    className="text-xl cursor-pointer w-[5%] text"
                ...
                <h2 className="herotext_color text-2xl w-[75%] cursor-pointer">
                  {ele.question}
                </h2>
