...
export default function Slider() {
  return (
      <section className="container flex items-center justify-center gradient_bg pt-20 pb-25">
        ...
        loop={true}
        className="mySwiper">
              <SwiperSlide><SliderDiv sliderCard={sliderCard[0]}/></SwiperSlide>
              <SwiperSlide><SliderDiv sliderCard={sliderCard[1]}/></SwiperSlide>
              <SwiperSlide><SliderDiv sliderCard={sliderCard[2]}/></SwiperSlide>
        </Swiper>
      </div>
    </section>
  );
